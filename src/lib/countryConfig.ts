...
export const COUNTRY_CONFIG: Record<CountryCode, CountryConfig> = {
  IE: {
    ...
    flag: 'IE',
    oneTimePrice: 1995,
    oneTimePriceDisplay: 'EUR19.95',
    professionalPrice: 'EUR190-EUR240',
    expertMonthly: 2995,
    expertAnnual: 24900,
  ...
  UK: {
    ...
    flag: 'GB',
    oneTimePrice: 2395,
    oneTimePriceDisplay: 'GBP23.95',
    professionalPrice: 'GBP300-GBP600',
    expertMonthly: 2995,
    expertAnnual: 24900,
  ...
  AU: {
    ...
    flag: 'AU',
    oneTimePrice: 3995,
    oneTimePriceDisplay: '$39.95 AUD',
    professionalPrice: '$400-$800 AUD',
    expertMonthly: 2995,
    expertAnnual: 24900,
  ...
  US: {
    ...
    flag: 'US',
    oneTimePrice: 2995,
    oneTimePriceDisplay: '$29.95 USD',
    professionalPrice: '$400-$700 USD',
    expertMonthly: 2995,
    expertAnnual: 24900,
  ...
  CA: {
    ...
    flag: 'CA',
    oneTimePrice: 3495,
    oneTimePriceDisplay: '$34.95 CAD',
    professionalPrice: '$350-$600 CAD',
    expertMonthly: 2995,
    expertAnnual: 24900,
